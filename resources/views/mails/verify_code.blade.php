                                                ...
                                                <div style="font-family: Georgia, 'Times New Roman', serif">
                                                    <div
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; text-align: center;"><span
                                                                style="font-size:42px;">Verify Code</span></p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td style="padding-bottom:80px;padding-left:30px;padding-right:30px;padding-top:10px;">
                                                <div style="font-family: sans-serif">
                                                    <div
                                                        ...
                                                        <p style="margin-bottom: 10px; font-size: 14px;  mso-line-height-alt: 60px;">
                                                            <span style="font-size:16px;">Hi {{ $user->name }}</span>
                                                        </p>
                                                        <p style="margin: 0; font-size: 14px;  mso-line-height-alt: 80px;">
