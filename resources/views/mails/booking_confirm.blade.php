                                                ...
                                                <div style="font-family: Georgia, 'Times New Roman', serif">
                                                    <div
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; text-align: center;"><span
                                                                style="font-size:42px;">Xác nhận tour</span></p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 24px;">
                                                            <span
                                                                style="font-size:16px;">Xin chào <strong><u>{{ $booking->customer->first_name }}</u></strong>,</span>
                                                        </p>
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 24px;"><span
                                                                style="font-size:16px;">Tour của bạn đã được xác nhận và lên lịch vào <strong><span
                                                                        style="">{{ date('d/m/Y',strtotime($booking->departure_time)) }}</span></strong>
                                                                            </span>
                                                        </p>
                                                        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 24px;"><span
                                                                style="font-size:16px;">Nếu bạn có thắc mắc nào có thể liên hệ: <strong><span
                                                                        style="">01234566789</span></strong> để được hỗ trợ
                                                                            </span>
                                                        </p>
                                                        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;">
                                                             </p>
                                                    ...
                                                    <div
                                                        ...
                                                        <p style="margin: 0; font-size: 16px; text-align: right;">
                                                            <strong><span style="font-size:16px;"><span
                                                                        style="color:#5d77a9;">Tour</span></span></strong>
                                                        </p>
                                                        <p style="margin: 0; font-size: 16px; text-align: right;">
                                                            <strong><span style="font-size:16px;"><span
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div
                                                        ...
                                                        <p style="margin: 0; font-size: 16px; text-align: left;">
                                                            <span
                                                                style="font-size:16px;">{{ $booking->tour->name }}</span>
                                                        </p>
                                                        <p style="margin: 0; font-size: 16px; text-align: left;">
                                                            <span
                                                                style="font-size:16px;">{{ date('d/m/Y',strtotime($booking->departure_time)) }}</span>
                                                        </p>
                                                        <p style="margin: 0; font-size: 16px; text-align: left;">
                                            ...
                                            <td>
                                                <div style="font-family: sans-serif">
                                                    <div
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; text-align: center;"><span
                                                                style="font-size:12px;">2022 © All Rights Reserved</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
