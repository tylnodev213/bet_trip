                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block"
                                        ...
                                        <tr>
                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                <p style="text-align: center; color: white; font-size: 22px">GoodTrip</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                ...
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                            ...
                            <tr>
                                <td class="column"
                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 40px; padding-bottom: 20px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
                                    width="100%">
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div
                                                        ...
                                                        <p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 24px;">
                                                            <span
                                                                style="font-size:16px;">Xin chào <u><strong>Admin</strong></u>,</span>
                                                        </p>
                                                        <p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 21px;">
                                                             </p>
                                                        <p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 24px;">
                                                            <span style="font-size:16px;">Đã có một khách hàng huỷ tour  {{ $booking->tour->name }}</span><span
                    ...
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                            ...
                            <tr>
                                ...
                                <td class="column"
                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; background-color: #5d77a9; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
                                    width="50%">
                                    <table border="0" cellpadding="0" cellspacing="0" class="text_block"
                                           role="presentation"
                                           style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;"
                    ...
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                            ...
                            <tr>
                                ...
                                <td class="column"
                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-bottom: 1px solid #5D77A9; border-left: 1px solid #5D77A9; border-right: 1px solid #5D77A9; border-top: 1px solid #5D77A9;"
                                    width="50%">
                                    <table border="0" cellpadding="0" cellspacing="0" class="text_block"
                                           role="presentation"
                                           style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;"
                                            ...
                                            <td style="padding-bottom:10px;padding-left:20px;padding-right:20px;padding-top:15px;">
                                                <div style="font-family: sans-serif">
                                                    <div
                                                        ...
                                                        <p style="margin: 0; font-size: 16px; mso-line-height-alt: 24px;">
                                                            <span style="font-size:16px;"><strong><span
                                                                        style="color:#5d77a9;">Email:</span></strong>{{ $booking->customer->email }}</span>
                                                        </p>
                                                        <p style="margin: 0; font-size: 16px; mso-line-height-alt: 24px;">
                                                            <span style="font-size:16px;"><strong><span
                                                    ...
                                                    <div
                                                        ...
                                                        <p style="margin: 0; font-size: 16px;"><span
                                                                style="color:#5d77a9;"><strong><span
                                                                        style="font-size:16px;">Công ty GoodTrip</span></strong>
                                                                            </span>
                                                        </p>
                                                        <p style="margin: 0; font-size: 16px; mso-line-height-alt: 24px;">
                                                            <span
                                                                style="font-size:16px;">{{ config('config.email') }}</span>
                                                        </p>
                                                        <p style="margin: 0; font-size: 16px; mso-line-height-alt: 24px;">
                                                            <span style="font-size:16px;">{{ config('config.tel') }}</span></p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                <td class="column"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="text_block"
                                           ...
                                           width="100%">
                                        <tr>
                                            <td style="padding-bottom:10px;padding-left:30px;padding-right:30px;padding-top:30px;">
                                                <div style="font-family: sans-serif">
                                                    <div
                                                        ...
                                                        <p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 24px;">
                                                            <span style="font-size:16px;color:#5d77a9;">Vui lòng xác nhận tại <a
                                                                    href="{{ route('bookings.show', $booking->id) }}">đây</a></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div
                                                        ...
                                                        <p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;">
                                                            <span
                                                                style="font-size:12px;">{{ config('config.address') }}</span>
                                                        </p>
                                                        <p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;">
                                                            <span style="font-size:12px;">{{ config('config.email') }} </span>
                                                        </p>
                                                        <p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;">
                                                            <span style="font-size:12px;">{{ config('config.tel') }}</span></p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; text-align: center;"><span
                                                                style="font-size:12px;">2024 © All Rights Reserved</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td style="padding-left:10px;padding-right:10px;">
                                                <div style="font-family: sans-serif">
                                                    <div
                                                        style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #cfceca; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                        <p style="margin: 0; font-size: 14px; text-align: center;"><span
                                                                style="font-size:12px;"><a href="http://www.example.com"
                                                                                           rel="noopener"
                                                                                           style="color: #cfceca;"
                                                                                           target="_blank">Unsubscribe</a> | <a
                                                                    href="http://www.example.com" rel="noopener"
                                                                    style="color: #cfceca;" target="_blank">Manage Preferences</a></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
